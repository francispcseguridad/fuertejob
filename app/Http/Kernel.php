...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        // \App\Http\Middleware\TrustHosts::class, // Usar si estás detrás de un proxy
    ...
    protected $middlewareGroups = [
        ...
        'api' => [
            // \Laravel\Sanctum\Http\Middleware\EnsureFrontendRequestsAreStateful::class, // Descomentar si usas Sanctum
            'throttle:api',
            \Illuminate\Routing\Middleware\SubstituteBindings::class,
        ],
    ];
