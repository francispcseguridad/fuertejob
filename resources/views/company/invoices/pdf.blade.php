...
<body onload="window.print()">
    ...
    <div class="no-print" style="margin-bottom: 20px; text-align: right;">
        <button onclick="window.print()"
            style="padding: 10px 20px; cursor: pointer; background: #0d6efd; color: white; border: none; border-radius: 4px;">Imprimir
            / Guardar PDF</button>
    </div>
                ...
                <td>
                    ...
                    <span style="color: #777; font-size: 14px;">
                        @if ($invoice->bonoPurchase)
                            {{ $invoice->bonoPurchase->bonoCatalog->name ?? 'Bono Servicios' }}
                        @else
    ...
    <div class="footer">
        <p>Gracias por su confianza. Si tiene alguna duda sobre esta factura, póngase en contacto con nosotros.</p>
    </div>
