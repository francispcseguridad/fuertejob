...
@section('content')
    <div class="bg-white shadow sm:rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <h3 class="text-lg leading-6 font-medium text-gray-900">Editar Menú: {{ $menu->title }}</h3>
            <div class="mt-5">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <select id="location" name="location"
                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md p-2 border">
                                    <option value="primary" {{ $menu->location == 'primary' ? 'selected' : '' }}>Barra
                                        Principal (Header)</option>
                                    <option value="footer_1" {{ $menu->location == 'footer_1' ? 'selected' : '' }}>Footer
                                        Columna 1 (FuerteJob)</option>
                                    <option value="footer_2" {{ $menu->location == 'footer_2' ? 'selected' : '' }}>Footer
                                        Columna 2 (Empresas)</option>
                                    <option value="footer_3" {{ $menu->location == 'footer_3' ? 'selected' : '' }}>Footer
                                        Columna 3 (Solicitantes)</option>
                                </select>
                            </div>
                        </div>
