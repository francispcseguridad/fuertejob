@extends('layout.app')
@section('title', 'Crear CTA Empresa')
@section('content')
    <div class="bg-white shadow sm:rounded-lg p-6">
        <h3 class="text-lg font-medium text-gray-900">Crear CTA Empresa</h3>
        <form action="{{ route('admin.home_company_ctas.store') }}" method="POST" class="mt-5 space-y-6">
            @csrf
            <div>
