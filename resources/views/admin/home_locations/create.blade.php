...
@section('content')
    <div class="bg-white shadow sm:rounded-lg p-6">
        <h3 class="text-lg font-medium text-gray-900">Crear Ubicación</h3>
        <form action="{{ route('admin.home_locations.store') }}" method="POST" class="mt-5 space-y-6">
            @csrf
            <div>
                <label class="block text-sm font-medium text-gray-700">Nombre (Ej: Fuerteventura)</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700">URL Destino (Opcional)</label>
