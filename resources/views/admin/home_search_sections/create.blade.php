@extends('layout.app')
@section('title', 'Crear Sección Buscador')
@section('content')
    <div class="bg-white shadow sm:rounded-lg p-6">
        <h3 class="text-lg font-medium text-gray-900">Crear Sección Buscador</h3>
        <form action="{{ route('admin.home_search_sections.store') }}" method="POST" class="mt-5 space-y-6">
            @csrf
            <div>
