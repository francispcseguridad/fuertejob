...
@section('title', 'Crear Contenido CMS/Blog')
...
@section('content')
    @php
        $initialType = old('type', array_key_first($types));
    ...
    <div class="container py-4">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
            <div>
                ...
                <h1 class="h3 fw-bold text-dark mb-0">Crear nuevo contenido</h1>
                <p class="text-muted mb-0">Gestiona páginas legales o artículos destacados con herramientas enriquecidas.
                </p>
            </div>
        ...
        <form method="POST" action="{{ route('admin.cms_contents.store') }}" enctype="multipart/form-data"
            id="cms-content-form">
            @csrf
            <div class="row g-4">
                <div class="col-lg-8">
                        ...
                        <div class="card-body p-4 p-lg-5">
                            <div class="mb-4">
                                ...
                                <input type="text" name="title" id="title" value="{{ old('title') }}" required
                                    ...
                                    placeholder="Ej: Política de privacidad 2024">
                                @error('title')
                            ...
                            <div class="mb-4">
                                <label for="slug" class="form-label fw-semibold">Slug (opcional)</label>
                                <input type="text" name="slug" id="slug" value="{{ old('slug') }}"
                                    class="form-control form-control-lg @error('slug') is-invalid @enderror"
                                    placeholder="ejemplo-de-slug">
                                <small class="text-muted">Se genera automáticamente si lo dejas vacío.</small>
                                @error('slug')
                        ...
                        <div class="card-body p-4 p-lg-5">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <div>
                                    ...
                                    <p class="text-muted mb-0">Recorta en proporción 1000x500 para mantener consistencia.
                                    </p>
                                </div>
                            ...
                            <div class="mb-3">
                                <label for="image_upload" class="form-label">Archivo de imagen</label>
                            ...
                            <p class="text-muted small mb-0">
                                <i class="bi bi-info-circle me-1 text-primary"></i>Si no recortas la imagen, se usará la
                                versión original cargada.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" role="switch" id="is_published"
                                    name="is_published" value="1" @checked(old('is_published'))>
                            ...
                            <input type="hidden" name="user_id" value="{{ old('user_id', $currentUserId) }}">
                        </div>
                    </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="meta_description" id="meta_description" rows="3" maxlength="500"
                                    class="form-control @error('meta_description') is-invalid @enderror" placeholder="Breve resumen para buscadores">{{ old('meta_description') }}</textarea>
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    ...
                                    <p class="text-muted mb-0">Crea un enlace en el menú público hacia esta página.</p>
                                </div>
                            ...
                            <div id="menu-fields" class="{{ $menuEnabledValue ? '' : 'd-none' }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-control bg-light" id="menu_url_preview">
                                        {{ $menuInfoBaseUrl . ltrim(old('slug', ''), '/') }}
                                    </div>
                                    <small class="text-muted">Se construye automáticamente con el slug.</small>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="menu_title" id="menu_title"
                                        ...
                                        value="{{ old('menu_title', optional($linkedMenu)->title ?? old('title', '')) }}"
            ...
            <div class="d-flex justify-content-end mt-4">
                <button type="submit" class="btn btn-primary btn-lg rounded-pill px-5">
                    <i class="bi bi-save2 me-2"></i>Guardar contenido
                </button>
            </div>
        </form>
    </div>
